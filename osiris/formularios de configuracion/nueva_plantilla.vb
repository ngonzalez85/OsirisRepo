...
Public Class nueva_plantilla
    ...
    Private Sub nueva_plantilla_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'Combobox Fuentes
    ...
    Private Sub actualizar_plantilla()
        ...
        'myCommand.Connection = conec
        myCommand.Connection = conec 'Cadena de conexión.
        myCommand.CommandText = "UPDATE plantillas SET descripcion=?descripcion,plantilla=?plantilla,idtipoestudio=?idtipoestudio WHERE idplantilla =" & txtidplantilla.Text
        myCommand.Parameters.AddWithValue("?descripcion", txtdescripcion.Text)
        myCommand.Parameters.AddWithValue("?plantilla", arrFile)
        myCommand.Parameters.AddWithValue("?idtipoestudio", txtidtipoestudio.Text)
    ...
    Private Sub btnRegistrar_Click(sender As Object, e As EventArgs) Handles btnRegistrar.Click
        If txtidplantilla.Text <> "" Then
            If txtdescripcion.Text <> "" And txtidtipoestudio.Text <> "" Then
                ...
                limpiar()
                plantillas.llenar_datagridview_plantillas()
                Me.Close()
            Else
    ...
    Private Sub obtener_plantilla()
        Try

            Dim tabla As DataTable = MuestraDB("SELECT plantilla FROM plantillas WHERE idplantilla='" & txtidplantilla.Text & "'")
    ...
    Private Sub txtidtipoestudio_TextChanged(sender As Object, e As EventArgs) Handles txtidtipoestudio.TextChanged
        If txtidplantilla.Text <> "" And txtidtipoestudio.Text <> "" Then
            consultar_tipoestudio(txtidtipoestudio.Text)
            If dr.Read Then
